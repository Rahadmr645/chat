export function IconSearch() {
  return (
    <svg className="chatHdrIcon" viewBox="0 0 24 24" aria-hidden="true">
      <path
        fill="currentColor"
...
export function IconCall() {
  return (
    <svg className="chatHdrIcon" viewBox="0 0 24 24" aria-hidden="true">
      <path
        fill="currentColor"
        d="M6.62 10.79a15.055 15.055 0 006.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1C10.61 21 3 13.39 3 4c0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.24.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"
      />
    </svg>
  );
}
...
export function IconAttach() {
  return (
    <svg className="chatComposeIcon" viewBox="0 0 24 24" aria-hidden="true">
      <path
        fill="currentColor"
...
export function IconMic() {
  return (
    <svg className="chatComposeIcon" viewBox="0 0 24 24" aria-hidden="true">
      <path
        fill="currentColor"
        d="M12 14c1.66 0 3-1.34 3-3V5c0-1.66-1.34-3-3-3S9 3.34 9 5v6c0 1.66 1.34 3 3 3zm5.91-3c-.49 0-.9.36-.98.85C16.52 14.2 14.48 16 12 16s-4.52-1.8-4.93-4.15c-.08-.49-.49-.85-.98-.85-.61 0-1.09.54-1 1.14.49 3.41 3.4 6.86 8.91 7.14V21H9v2h6v-2h-2v-2.06c5.51-.28 8.42-3.73 8.91-7.14.1-.6-.39-1.14-1-1.14z"
      />
    </svg>
  );
}
...
export function IconTrash() {
  return (
    <svg className="waVoiceDockTrashSvg" viewBox="0 0 24 24" aria-hidden="true">
      <path
        fill="currentColor"
...
/** Loudspeaker / hands-free during voice calls */
export function IconSpeakerLoud() {
  return (
    <svg className="callCtrlIcon" viewBox="0 0 24 24" aria-hidden="true">
      <path
        fill="currentColor"
...
/** Earpiece / phone-at-ear (normal) routing */
export function IconPhoneHandset() {
  return (
    <svg className="callCtrlIcon" viewBox="0 0 24 24" aria-hidden="true">
      <path
        fill="currentColor"
...
/** Compact icons for the message context popover (WhatsApp-style). */
export function IconMsgReply() {
  return (
    <svg className="messageCtxIcon" viewBox="0 0 24 24" aria-hidden="true">
      <path
        fill="currentColor"
...
export function IconMsgForward() {
  return (
    <svg className="messageCtxIcon" viewBox="0 0 24 24" aria-hidden="true">
      <path fill="currentColor" d="M12 8V4l8 8-8 8v-4H4V8h8z" />
    </svg>
  );
}

export function IconMsgStar() {
  return (
    <svg className="messageCtxIcon" viewBox="0 0 24 24" aria-hidden="true">
      <path
        fill="currentColor"
